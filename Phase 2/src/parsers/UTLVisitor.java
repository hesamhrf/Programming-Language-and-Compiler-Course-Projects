...
public interface UTLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link UTLParser#globalVarDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGlobalVarDeclaration(UTLParser.GlobalVarDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link UTLParser#complexTypeId}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComplexTypeId(UTLParser.ComplexTypeIdContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link UTLParser#especialFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEspecialFunction(UTLParser.EspecialFunctionContext ctx);
	/**
	 * Visit a parse tree produced by {@link UTLParser#especialVariable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEspecialVariable(UTLParser.EspecialVariableContext ctx);
	/**
	 * Visit a parse tree produced by {@link UTLParser#especialMethod}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEspecialMethod(UTLParser.EspecialMethodContext ctx);
	/**
